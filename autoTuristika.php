...
$app = new App();
$result = $app->getAllArticleCycle('auto');
?>
    ...
    <div class="center-wrapper">
            ...
            <div id="navigation">
                ...
                <div id="main-nav">
                    ...
                    <ul class="tabbed">
                        ...
                        <li class="current-tab"><a href="autoTuristika.php">Auto turistika</a></li>
        ...
        <div class="main">
            ...
            while($row = $result->fetch_array()){
                ...
                <div class="post">
                    ...
                    <div class="post-body">
                        ...
                        <a href='autoTuristika.php?clanok=<?php echo $row['ID'] ?> ' class='more'>Read more &#187;</a>
            ...
            <div class="pagination" align="center">
                ...
                <?php $app->showPagination('auto') ?>
            </div>
            <?php } else { $app->incCountOfVisitors($_GET['clanok']); ?>
                <div class="post">

                    <a href='autoTuristika.php' class='back'>&#171 Späť</a>
