        ...
        <div class="main">
            ...
            <div class="post">
                ...
                <div class="post-body">
                    ...
                    <a href='cyklistika.php?clanok=<?php echo $row['ID'] ?> ' class='more'>Read more &#187;</a>
            ...
            <div class="pagination" align="center">
                <br />
                <?php $app->showPagination('cyklistika') ?>
            </div>

            <?php } else {
                    //zvysi pocet_navstev u clanku o jeden
                    $app->incCountOfVisitors($_GET['clanok']); ?>
            <div class="post">
                <?php echo "<a href='cyklistika.php' class='back'>&#171 Späť</a>" ?>
